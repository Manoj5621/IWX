  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setStats(prev => ({
        ...
        visitors: prev.visitors + Math.random() * 10 - 5,
        conversionRate: prev.conversionRate + Math.random() * 0.1 - 0.05
      }));
    }, 3000);
              ...
              <div className="metrics-grid">
                <div className="metric-card">
                  ...
                  <div className="metric-content">
                    ...
                    <p className="metric-value">
                      $<AnimatedValue value={stats.totalSales + stats.revenue} />
                    </p>
                ...
                <div className="metric-card">
                  ...
                  <div className="metric-content">
                    <h3>Total Orders</h3>
                    <p className="metric-value">
                      <AnimatedValue value={stats.totalOrders} />
                    </p>
                    <div className="metric-trend up">
                ...
                <div className="metric-card">
                  ...
                  <div className="metric-content">
                    ...
                    <p className="metric-value">
                      <AnimatedValue value={stats.totalCustomers} />
                    </p>
                    <div className="metric-trend up">
                ...
                <div className="metric-card">
                  ...
                  <div className="metric-content">
                    ...
                    <p className="metric-value">
                      <AnimatedValue value={(3.2 + stats.conversionRate).toFixed(1)} suffix="%" />
                    </p>
